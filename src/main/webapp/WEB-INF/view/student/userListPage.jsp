...
<script>
    $.getJSON('/user/getUserList', {curr: 1,limit:10,type:'1'}, function(res){ //从第6页开始请求。返回的json格式可以任意定义
        laypage({
            limit:10,
            ...
            jump: function(e){ //触发分页后的回调
                console.log(e);
                $.getJSON('/user/getUserList', {curr: e.curr,limit:e.limit,type:'1'}, function(res){
                    var zz = res.content;
                    var htmllet = "";
