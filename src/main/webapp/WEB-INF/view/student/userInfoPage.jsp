                ...
                <div class="mainBody">
                    ...
                    <table style="border-collapse:separate; border-spacing:0px 30px;">
                        <tr>
                            ...
                            <td>
                                ASDSDA_123124214<a class="Hui-iconfont Hui-iconfont-edit2" title="信息修改" style="font-size: 30px!important;"></a>
                            </td>
                        </tr>
                        <tr>
                            <td>头像</td>
                            <td><img src="../../img/zlg.jpg" alt="" class="round" style="width: 60px; height: 50px;"></td>
                        </tr>
                        <tr>
                            <td>昵称</td>
                            <td>小龙人</td>
